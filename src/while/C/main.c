...
int main(int argc, char *argv[]) {
  ...
  LLVMValueRef cmpVal = LLVMBuildICmp(builder, LLVMIntSLT, i_cmp, LLVMConstInt(LLVMInt64Type(), 1024, false), "while_test");

  // Teste do loop.
  LLVMBuildCondBr(builder, cmpVal, bodyBlock, endLoopBlock);
